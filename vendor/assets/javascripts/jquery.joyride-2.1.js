    ...
    methods = {
      ...
      steps_html : function (opts) {
        ...
        if (settings.showStepCounter) {
          ...
          step_counter.append((opts.index+1) + ' / '+ $($(opts.li).parent()).children('li').size()) ;
      ...
      show : function (init) {
        ...
        if (settings.$li === undefined || ($.inArray(settings.$li.index(), settings.pauseAfter) === -1)) {
          ...
          if (settings.$li.length && settings.$target.length > 0) {
            ...
            settings.tipSettings.tipAdjustmentY = -settings.$current_tip.outerHeight()/2;
            settings.tipSettings.tipAdjustmentX = 40;
      ...
      set_next_tip : function () {
        ...
        // Add specific class to tips
        settings.$next_tip.addClass( 'tip-num-'+ settings.$li.index() )
      },
      ...
      scroll_to : function () {
        ...
        tipOffset = Math.ceil(settings.$target.offset().top - window_half + settings.$next_tip.outerHeight() - 300);
